    ...
    render() {
        return (
            ...
            <View style= {styles.inputContainer}>
                <Icon name={'ion-ios-person-outline'} size={28} color={'rgba(255,0,0,0.3)'}
                
                style={styles.inputIcon}></Icon>
                
                <TextInput onChangeText={(text)=>this.setState({email:text})}
                value={this.state.email}
                style={styles.inputtext} placeholder={'Username'} placeholderTextColor={'#173F5F'} UnderlineColorAndroid='transparent'/>
           </View>
